...
CRISIS_INSTRUCTION_LEVEL2 = (
    ...
    "2. Если нет \u2192 дай контакт: \u00abНасилию.нет\u00bb 8-495-916-30-00, "
...
_LEVEL2_KEYWORDS: list[str] = [
    ...
    "ударил", "ударила",  # свободный порядок слов: "меня вчера ударил"
    "душит меня", "душил меня",
    "угрожает убить", "угрожает мне",
    "боюсь его", "боюсь её", "боюсь мужа",
    "поднимает руку", "избивает",
    # self-harm (перенесено из L3 — нужен Claude с инструкцией, не шаблон)
...
_LEVEL1_KEYWORDS: list[str] = [
    ...
    "умираю",  # LLM-верификация отсечёт "умираю от смеха"
]
