...
## Фаза: ПЛАНИРОВАНИЕ ЗАВЕРШЕНО → переход к АРХИТЕКТУРЕ (Фаза 2)
## Подэтап: Шаги 0-4 завершены. Следующий: шаг 5 (схема хранения данных)
...
6. **Шаг 5:** Схема хранения данных (БД) ← СЛЕДУЮЩИЙ
7. **Шаг 6:** Контракты модулей (specs/)
8. **Шаг 7:** Спецификация промптов (8 штук)
9. После шагов 5-7 → код (шаги 8+, субагенты вступают)
